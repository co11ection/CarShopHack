...
class RegistrationView(APIView):
    ...
    def post(self, request):
        serializer = serializers.RegistrSerializer(data=request.data)
...
class LogoutApiView(GenericAPIView):
    ...
    def post(self, request, *args):
        ...
        serializer.save()
        return Response('Saccessfully loged out', status=204)
...
class RestorePasswordView(APIView):
    ...
    def post(self, request):
        serializer = serializers.RestorePasswordSerialzer(data = request.data)
        serializer.is_valid(raise_exception=True)
        serializer.save()
